...
def draw_ser_results(image,
                     ...
                     font_size=14):
    np.random.seed(2021)
    # mapping_name = {"QUESTION": "KEY",
    #                         "ANSWER": "VALUE", "HEADER": "TITLE", "other": "OTHER"}
    ...
    font_path = os.path.join(dname, font_path)
    ...
    for ocr_info in ocr_results:
        ...
        # text = "{}".format(mapping_name[ocr_info["pred"]])
...
def draw_re_results(image,
    ...
    for ocr_info_head, ocr_info_tail in result:
        # draw_box_txt(ocr_info_head["bbox"], mapping_name[ocr_info_head["transcription"]],
        #              draw, font, font_size, color_head)
        # draw_box_txt(ocr_info_tail["bbox"], mapping_name[ocr_info_tail["transcription"]],
        #              draw, font, font_size, color_tail)
        draw_box_txt(ocr_info_head["bbox"], ocr_info_head["pred"],
                     draw, font, font_size, color_head)
        draw_box_txt(ocr_info_tail["bbox"], ocr_info_tail["pred"],
                     draw, font, font_size, color_tail)
        center_head = (
