...
from key_value_extractor.ppocr.data.imaug.iaa_augment import IaaAugment
from key_value_extractor.ppocr.data.imaug.random_crop_data import is_poly_outside_rect
