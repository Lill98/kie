...
from key_value_extractor.ppocr.utils.utility import check_install

from key_value_extractor.ppocr.utils.e2e_metric.polygon_fast import iod, area_of_intersection, area
