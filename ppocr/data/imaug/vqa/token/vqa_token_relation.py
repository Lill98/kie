...
class VQAReTokenRelation(object):
    ...
    def __call__(self, data):
        ...
        # print("--------entity_id_to_index_map", entity_id_to_index_map)
        ...
        kv_relations = []
        # pair_key = (["key_big", "key"], ["key", "value"])
        # pair_key_inverse = (["key", "key_big"], ["value", "key"])
        ...
        relations = sorted(
            ...
            key=lambda x: x["head"], )
        # print("+++++after relations", relations)
