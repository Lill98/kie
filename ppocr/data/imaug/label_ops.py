...
from key_value_extractor.ppocr.data.imaug.vqa.augment import order_by_tbyx
...
class VQATokenLabelEncode(object):
    ...
    def __init__(self,
        ...
        from key_value_extractor.ppocr.utils.utility import load_vqa_bio_label_maps
        tokenizer_dict = {
            'LayoutXLM': {
    ...
    def filter_empty_contents(self, ocr_info):
        ...
        # print("-----empty_index", empty_index)
        # import ipdb
        # ipdb.set_trace()
        for idx, info in enumerate(new_ocr_info):
            new_link = []
            # if not info["linking"]:
            #     print("link", type(info["linking"]))
    ...
    def __call__(self, data):
        ...
        for info in ocr_info:
            ...
            # print("----encode_res", encode_res["input_ids"])
        # print("gt_label_list", gt_label_list)
        # print("--------input_ids_list", len(input_ids_list))
        ...
        # print("data['tokenizer_params']", data['tokenizer_params'])
        if train_re:
    ...
    def _parse_label(self, label, encode_res):
        # print("self.label2id_map", self.label2id_map)
        gt_label = []
        # print("--label", label)
        # print("encode_res", encode_res["input_ids"])
