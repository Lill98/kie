...
from key_value_extractor.ppocr.utils.visual import draw_ser_results
from key_value_extractor.ppocr.utils.utility import get_image_file_list, load_vqa_bio_label_maps
import key_value_extractor.tools.program as program
...
class SerPredictor(object):
        ...
        for op in config['Eval']['dataset']['transforms']:
            ...
            if op_name == 'KeepKeys':
                op[op_name]['keep_keys'] = [
                        ...
                        'image', 'labels', 'segment_offset_id', 'ocr_info','entities'
                    ]
    ...
    def __call__(self, data):
        """Prepare image and infer model ser

        Args:
            data (dict): input dictionary

        Returns:
            list: list result and input after process
        """
