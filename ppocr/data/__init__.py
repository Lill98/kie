...
from key_value_extractor.ppocr.data.imaug import transform, create_operators
from key_value_extractor.ppocr.data.simple_dataset import SimpleDataSet, MultiScaleDataSet
from key_value_extractor.ppocr.data.lmdb_dataset import LMDBDataSet, LMDBDataSetSR, LMDBDataSetTableMaster
from key_value_extractor.ppocr.data.pgnet_dataset import PGDataSet
from key_value_extractor.ppocr.data.pubtab_dataset import PubTabDataSet
from key_value_extractor.ppocr.data.multi_scale_sampler import MultiScaleSampler
...
def build_dataloader(config, mode, device, logger, seed=None):
    ...
    simpleclass = eval(module_name)
    # print("simpleclass", simpleclass)
    dataset = simpleclass(config, mode, logger, seed)
    # print(dataset.__dict__)
    if mode.lower() == "train":
        weight_class = dataset.weight_class
    else:
        weight_class = None
    # weight_class = simpleclass.weight_class
    ...
    #     # print("weight_class", weight_class)
    #     return data_loader, weight_class
    # else:
    #     return data_loader
